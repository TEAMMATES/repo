...
public class FeedbackSessionsLogicTest extends BaseLogicTest {
    ...
    public void testFeedbackSessionNotification() throws Exception {
        ...
        testGetFeedbackSessionsOpeningSoonWithinTimeLimit();
    }
    ...
    private void testGetFeedbackSessionsOpeningSoonWithinTimeLimit() throws Exception {
        ______TS("init : 0 standard sessions opening within time-limit");
        List<FeedbackSessionAttributes> sessionList = fsLogic.getFeedbackSessionsOpeningSoonWithinTimeLimit();
        ...
        sessionList = fsLogic.getFeedbackSessionsOpeningSoonWithinTimeLimit();
